...
export const startCleanupJob = () => {
  ...
  // -------------------------------------------------------------
  // 🆕 JOB 2: ลบ Booking เก่าที่ผ่านไปแล้ว (รันทุกเที่ยงคืน 00:00 น.)
  // -------------------------------------------------------------
...
// '*/5 * * * *' = ทำทุกๆ 5 นาที (เหมาะกับช่วงคนใช้งานเยอะมากๆ แต่จะเปลือง resource หน่อย)

// '0 * * * *' = ทำทุกต้นชั่วโมง (แนะนำอันนี้ สำหรับโปรเจคทั่วไป)

// '0 0 * * *' = ทำทุกเที่ยงคืนตรง (วันละครั้ง)
