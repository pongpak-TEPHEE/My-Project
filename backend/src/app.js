...
app.use(cors({
  // ⚠️⚠️⚠️⚠️⚠️⚠️ เราต้องตั้งค่าให้แค่ frontend เท่านั้นที่จะสามมารถ ⚠️⚠️⚠️⚠️⚠️⚠️
    origin: ["http://localhost:5173", "http://localhost:5174"], // '*' อนุญาตให้ทุกคนเข้าถึงได้ (เหมาะสำหรับช่วง Dev/Test/ngrok) ตอน implement ต้องใช้ domain เช่น origin: ['https://your-frontend-domain.com']
